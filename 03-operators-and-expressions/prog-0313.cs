...
|
|     Use bitwise operations by analogy with the previous two
|     problems. You can reset the bit at position p in the
|     number n as follows:
|
|       * n = n & (~(1 << p));
|
|     You can set bits in the unit at position p in the number
|     n as follows:
|
|       * n = n | (1 << p);
|
