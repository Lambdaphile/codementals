...
|     Then consequently enter n numbers with one for loop.
|     While entering each new number, save in two variables
|     the smallest and the largest number until this moment.
|     At the start initialize the smallest and the largest number
|     with Int32.MaxValue and Int32.MinValue respectively.
|
*/
