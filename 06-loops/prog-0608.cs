...
|
|     Write a program that calculates the nth Catalan number
|     by given n.
|
| Solutions and Guidelines:
|
|     Use the same concept of canceling the faction of simple
|     factors, like you probably did in the previous problem.
|     You may also read more about the Catalan numbers in Wikipedia
|     (http://en.wikipedia.org/wiki/Catalan_number) and use
|     the recurrent formula for calculating them.
|
*/
