...
|     virtual columns on the console. Each column should have
|     a width of 10 characters and the numbers should be left
|     aligned. The first number should be an integer in
|     hexadecimal; the second should be fractional positive;
|     and the third – a negative fraction. The last two numbers
|     have to be rounded to the second decimal place.
|
| Solutions and Guidelines:
|
|     Use the format strings explained in the "Composite
|     Formatting" section and the method Console.WriteLine().
