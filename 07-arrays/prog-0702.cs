...
|
|     Use an int[] array and a for-loop. Two arrays are equal
|     if they have the same value for the length and the values
|     for their elements. You can check for the second condition
|     using a for-loop.
|
*/
